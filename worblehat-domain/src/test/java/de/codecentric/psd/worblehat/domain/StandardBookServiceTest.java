...
public class StandardBookServiceTest {
	...
	@Before
	public void setup() {
		aBook = new Book("title", "author", "edition", "isbn", 2016, "Bla bla");
		aCopyofBook = new Book("title", "author", "edition", "isbn", 2016, "Bla bla");
		anotherBook = new Book("title2", "author2", "edition2", "isbn2", 2016, "Bla bla2");

		aBorrowedBook = new Book("title", "author", "edition", "isbn", 2016, "Bla bla");
		aBorrowing = new Borrowing(aBorrowedBook, BORROWER_EMAIL, NOW);
		aBorrowedBook.borrowNowByBorrower(BORROWER_EMAIL);

		aCopyofBorrowedBook = new Book("title", "author", "edition", "isbn", 2016, "Bla bla");
		...
		anotherBorrowedBook = new Book("title2", "author2", "edition2", "isbn2", 2016, "Bla bla");
